...
ReceiverController.prototype.setVolumeMute = function(volume, muted,  callback) {
    var data = {
        type: 'SET_VOLUME',
...
ReceiverController.prototype.setMute = function(muted, callback) {
    var data = {
        type: 'SET_VOLUME',
        volume: { muted:muted}
    };
...
ReceiverController.prototype.getMute = function(callback) {
    this.getStatus(function(err, status) {
        if(err) return callback(err);
        callback(null, status.volume);
    });
